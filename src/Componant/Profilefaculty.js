        ...
        <div class="overflow-x-auto relative  sm:rounded-lg bg-white p-10  space-y-5 w-full">
          ...
          <div className="pt-10 space-y-5">
            <div className="print-btn flex items-center space-x-3">
              ...
              <Tooltip content="Print" placement="bottom-end" className='text-white bg-black rounded p-2'><a href="#" id='print' class="text-3xl bg-class5-50 rounded-md text-white p-1  "><MdLocalPrintshop /></a></Tooltip>
            ...
            <table class="w-full text-sm text-center bg-class5-50 rounded-xl shadow-xl ">
              <thead class="text-xs text-gray-700 uppercase dark:bg-[#D9D9D9]">
                <tr className='text-white text-base'>
                  <th scope="col" class="w-20 h-20">Id</th>
                  <th scope="col" class="w-20 h-20">Profile</th>
                  <th scope="col" class="w-20 h-20">Name</th>
                  <th scope="col" class="w-20 h-20">Phone</th>
                  <th scope="col" class="w-20 h-20">Role</th>
                  <th scope="col" class="w-20 h-20">LastPaid</th>
