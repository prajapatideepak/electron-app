...
function Receipt_teacher() {
  ...
  const onSubmit = async (data, e) => {
    e.preventDefault();
    try {
      const admin_details = await getAdminVerification({
            ...
            <div className="flex justify-center  ">
              <div className="h-2/2 mx-auto  opacity-100 shadow-2xl rounded  mt-20 bg-white w-1/2 z-50">
                <div className="">
                  ...
                  <div className="mt-7">
                    <h1 className="text-2xl text-center font-bold text-darkblue-500 px-6 ">
          ...
          <div className="px-6">
            <div>
              <div className="flex justify-between">
                <h2 className=" font-bold text-darkblue-500 text-3xl pt-10">
                  Receipt
                </h2>

                {location?.state?.prevPath != "generate_receipt" &&
                location?.state?.prevPath != "update_receipt" ? (
                  <div className="lable  text-left flex justify-end items-center ">
                    <div
                      className="group h-9 w-20 flex justify-center items-center gap-1 pt-10 cursor-pointer"
                      id=""
                      onClick={() => navigate(-1)}
                    >
              ...
              <div className="py-5 pt-10" ref={printRef}>
                <ReceiptMainDiv
                  className={`border-4 rounded-3xl border-red-600 mx-auto mt-4`}
                  ref={printRef}
                >
                  <div className="p-5">
                    <div className="flex justify-between">
                      ...
                      <div className={`${receiptTextColor} w-48 font-bold`}>
                        <p>
                          E-35, Sumel-8, Safal Market, Nr. Ajit Mill Char Rasta,
                          Rakhial, Ahmedabad.
                        </p>
                    ...
                    <div className="flex justify-between items-center mt-5">
                      ...
                      >
                        <p className="text-sm text-white py-1 px-2 ">
                      ...
                      <div>
                        <p className={`${receiptTextColor} font-bold`}>
                          ...
                          <span className="text-black">
                            {facultyhistory.salary_receipt_id}
                          </span>
                        </p>
                      </div>
                    </div>
                    <div className="flex justify-between items-center mt-5">
                      <div className="">
                        <p
                          className={`${receiptTextColor} font-bold italic uppercase`}
                        >
                          Name:{" "}
                          <span className="text-black">
                            {facultyhistory?.staff_id?.basic_info_id.full_name}
                          </span>
                        </p>
                      </div>
                      <div>
                    ...
                    <div className="mt-5">
                      <p className={`${receiptTextColor} font-bold italic`}>
                        The sum of Rupees:{" "}
                        <span className="text-black">
                          {inWords(facultyhistory?.transaction_id?.amount)}{" "}
                        </span>
                      </p>
                    </div>
                    <div className="mt-5">
                    ...
                    {isHourly ? (
                      <div className="flex">
                        <div
                          className={`flex justify-center items-center w-36 h-8 ${receiptBgColor} mt-5 mr-5 rounded-md`}
                        >
                          <p className="text-white">
                            Per Lecture: {feesdetails?.rate_per_hour}
                          </p>
                        </div>
                        <div
                          className={`flex justify-center items-center w-36 h-8 ${receiptBgColor} mt-5 mr-5 rounded-md`}
                        >
                          <p className="text-white">
                            Total Lectures: {feesdetails?.total_hours}
                          </p>
                        </div>
                      </div>
                    ) : null}
                        ...
                        <div className=" relative flex justify-center items-center">
                          ...
                          <div className="border-2 border-red-600 rounded-full ml-2">
                            <input
                              ...
                              disabled
                              value={facultyhistory?.transaction_id?.amount}
                              style={{ margin: "1px" }}
                            />
                          </div>
                        </div>
                    ...
                    <div className="flex justify-between items-center mt-6">
                      <div className="">
                        <p
                          className={`${receiptTextColor} font-bold text-sm ml-1 `}
                        >
                          Admin:{" "}
                  ...
                  >
                    <div className="p-5">
                      <div className="flex justify-between">
                        ...
                        <div className={`${receiptTextColor} w-48 font-bold`}>
                          <p>
                            E-35, Sumel-8, Safal Market, Nr. Ajit Mill Char
                            Rasta, Rakhial, Ahmedabad.
                          </p>
                          <p className="pt-2">Mobile: 9725272326</p>
                        </div>
                      </div>
                      ...
                      <div className="flex justify-between items-center mt-5">
                        <div className="">
                          <p className={`${receiptTextColor} font-bold italic`}>
                            ...
                            <span className="text-black">
                              {
                                facultyhistory?.staff_id?.basic_info_id
                                  ?.full_name
                              }
                            </span>
                          </p>
                      ...
                      <div className="flex justify-between items-center mt-6">
                        <div className="">
                          ...
                          >
                            Admin:{" "}
                            <span className="text-black">
                              {facultyhistory.admin_id?.username}
                            </span>
                          </p>
                        </div>
                        <div>
              ...
              <div className="flex justify-center items-center">
                <button
                  className="flex justify-center items-center my-5 bg-indigo-900 py-1 px-3 rounded-md hover:bg-indigo-800"
