...
const Addadmin = () => {
  ...
  function handleNotification(data) {
    console.log(data);
    if (data.ok) {
      toast.success("Register Succuesfully", {
          position: "top-right",
          autoClose: 4000,
          hideProgressBar: false,
          closeOnClick: true,
    ...
    <div className="relative min-h-screen  ">
      ...
      <div className={`bg-slate-100 ${model && "opacity-5"}`}>
        <div className="xl:flex xl:justify-between justify-center items-center pr-5 pt-3 xl:pl-8 space-y-5">
          <h1
            className=" text-xl xl:text-3xl text-center text-darkblue-5003g  
          ...
          <div className="button flex justify-center  ">
            <div
              className="button flex justify-center text-center items-center space-x-4  "
        ...
        <div className="flex justify-center items-center p-10 pt-10">
          <div className="overflow-x-auto relative  sm:rounded-lg bg-white p-10 shadow-xl space-y-5 w-full">
            ...
            <table
              ref={componentRef}
              className="w-full text-sm text-center bg-class3-50 rounded-xl shadow-xl "
            >
