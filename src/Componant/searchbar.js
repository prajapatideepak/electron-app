...
export default function Searchbar() {
  ...
  return (
    <div onClick={handleToggle} className="w-full z-[999] sticky top-0 bg-white h-[70px] flex flex-row items-center justify-between shadow-[0_10px_10px_-15px_rgba(0,0,0,0.3)]">
      ...
      <div className="right">
        <div className="top grid grid-col-2 items-center cursor-pointer justify-right space-x-5 pr-5 static"  >
          <form action="" className="flex items-center space-x-2 cursor-pointer" id="profile">
            ...
            <div className="">
              <div className="mt-3 mb-3 ">
                ...
                <div className="bg-blue-200 w-1/6 h-9  flex justify-center items-center rounded-full">
                  ...
                  <span  className="md:text-sm xl:text-base">Change Section</span>
                </div>
                </NavLink>
