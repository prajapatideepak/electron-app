                          ...
                          <div className="flex lg:flex-row md:flex-col gap-4 items-center">
                            <div className="Class">
                              <label className="block">
                                ...
                                <select
                                  className={`2xl:w-[240px] w-[180px]  mt-1 block  px-3 py-2  border  border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 outline-none ${errors.is_primary && "border-red-600"
                                    }`}
                                  {...register("is_primary", {
                            ...
                            <div className="Stream">
                              <label className="block">
                                ...
                                <select
                                  className={`2xl:w-[240px] w-[180px]  mt-1 block px-3 py-2  border  border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 outline-none ${errors.stream && "border-red-600"
                                    }`}
                                  {...register("stream", {
                            ...
                            <div className="Fees">
                              <label className="block">
                                ...
                                <input
                                  ...
                                  className={`2xl:w-[240px] w-[180px]  mt-1 block  px-3 py-2 bg-white border  border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 outline-none ${errors.fees && "border-red-600"
                                    }`}
                                  {...register("fees", {
                                        ...
                                        <div className=" mt-1">
                                          <div className="input flex items-center border border-slate-300 rounded-md">
                                            <input
                                              ...
                                              disabled={true}
                                              placeholder="Starting year"
                                              className={`xl:w-24 2xl:w-28  block  px-3 py-2 bg-white rounded-md text-sm shadow-sm placeholder-slate-400 outline-none ${errors.batch_start_year &&
                                                "border-red-600"
                                                }`}
                                            ...
                                            <input
                                              ...
                                              disabled={true}
                                              placeholder="Ending year"
                                              className={`xl:w-28 2xl:w-32 block  px-3 py-2 bg-white  rounded-md text-sm shadow-sm placeholder-slate-400 outline-none ${errors.batch_end_year &&
                                                "border-red-600"
                                                }`}
                                  ...
                                  <div className="flex lg:flex-row md:flex-col gap-4 items-center">
                                    <div className="Class">
                                      <label className="block">
                                        ...
                                        <select
                                          className={`xl:w-52 2xl:w-60  mt-1 block  px-3 py-2  border  border-slate-300 rounded-md text-sm shadow-sm placeholder-slate-400 outline-none ${errors.is_primary && "border-red-600"
                                            }`}
                                          {...register("is_primary", {
                                            required: "Section is required",
                                          })}
                        ...
                        <div className="flex  space-x-2 items-center ml-3 ">
                          ...
                          <div className="flex flex-1 justify-center items-center">
                            <h1
                              ...
                              className={`text-xl font-bold ${item.class_name.length < 8 && "text-4xl"
