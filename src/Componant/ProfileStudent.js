...
import { getStudentDetails, studentAllAcademicDetails, updateStudent, cancelAdmission, getActiveClasses, transferStudent } from '../hooks/usePost';
        ...
        <>
            <section className={` p-10 pt-0 ${classSelectionModel ? 'opacity:20' : 'opacity:100'} `}>
                ...
                <div className={`bg-white overflow-x-auto relative  sm:rounded-lg  shadow-xl space-y-5 w-full`}>
                    ...
                    <form className="flex justify-center items-center " onSubmit={handleSubmit(onSubmit, onError)} >
                            ...
                            <div className="left flex flex-col items-center gap-5">
                                <div className='profile_img_div border-2 border-gray-500 shadow-lg'>
                                    ...
                                    <div className='profile_img_overlay flex flex-col justify-center items-center'>
                                        <input type='file' disabled={isEnable} className="rounded-md w-16" onChange={onImageChange} />
                        ...
                        <MdModeEditOutline/> <span style={{textTransform:'lowercase'}}> upload</span>
                            ...
                            <div className="right flex flex-col justify-center items-center gap-5">
                                ...
                                <div className="flex w-full justify-end pr-2 pt-7">
                                        ...
                                        border-2 hover:border-darkblue-500 hover:text-darkblue-500`} onClick={()=>{setClassSelectionModel(true); clearErrors();}} >
                                            Transfer
                                        </button>
                                              ...
                                              return <tr key={index} className=" border-b">
                                                ...
                                                <td className="w-20 h-20 ">
                                                    <div className='flex justify-center space-x-2'>
                                                        <NavLink className="nav-link" to= 'Studenthistory' state={ {academic_id: academic._id}}>
