...
function CancelAdmission() {
    ...
    const [studentDetails, setStudentDetails] = useState({
        ...
        // full_name: 'KARADIYA SADIKALI SHABBIRALI',
        // class_name: '5th',
        // medium: 'English',
        // stream: 'Commerce',
        // net_fees: 365,
        // discount: 0,
        // pending_fees: 0,
        // academic_start_date:  '2021/12/31'
    })
        ...
        try{
            ...
            if(res.data.success){
                ...
                setStudentDetails((prevData)=>{
                    return {
                        ...prevData,
                        pending_fees: res.data.fees_details.pending_amount,
                    }
                })

                //Updating new pending amount in location
                location.state.studDetails.fees.pending_amount = res.data.fees_details.pending_amount;
