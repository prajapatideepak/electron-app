      ...
      <section className="table h-full w-full  shadow-none">
        <div className=" justify-center items-center mt-2 p-10  pt-0">
          <div className="title py-6 flex justify-between items-center">
            ...
            <div
              className="btn cursor-pointer ml-5 h-10 w-24 rounded-md bg-white text-left border  overflow-hidden"
              id="btn"
              onClick={() => navigate(-1)}
            >
              <div
                className="icons  h-9 w-40 flex ml-2 items-center "
                id="icons"
              >
          ...
          <div className="overflow-x-auto relative  sm:rounded-lg bg-white p-10 shadow-xl space-y-5 w-full">
                    ...
                    <tr className=" border-b" key={index}>
                      ...
                      <td scope="row" className="w-20 h-20">
                        <input
                          ...
                          disabled={isEditable}
                          onChange={(e) =>
                            handleMyclassName(e.target.value, index)
                          }
                          className="rounded-md w-16 h-7 text-center bg-white"
                          defaultValue={item.class_name}
                          style={{
                            border: isEditable ? false : "2px solid #f8b26a",
                          }}
                        />
                      </td>
                      <td className="w-28 h-20 space-x-4">
                        <input
                          ...
                          disabled={true}
                          className=" rounded-md w-16 h-7 text-center bg-white"
                          defaultValue={item.batch_start_year + 1}
                        />
                        ...
                        <input
                          ...
                          disabled={true}
                          className=" rounded-md w-16 h-7 text-center bg-white"
                          defaultValue={item.batch_end_year + 1}
                        />
                      </td>
                      <td className="w-20 h-20">
                        <select
                          name=""
                          disabled={isEditable}
                          onChange={(e) => handleMedium(e.target.value, index)}
                        ...
                        >
                          <option
                            value="english"
                            defaultValue={
                              item.medium == "english" ? true : false
                            }
                          >
                            English
                          </option>
                          <option
                            value="gujarati"
                            defaultValue={
                              item.medium == "gujarati" ? true : false
                            }
                          >
                            Gujarati
                          </option>
                          <option
                            value="hindi"
                            defaultValue={item.medium == "hindi" ? true : false}
                          >
                            Hindi
                          </option>
                        </select>
                      ...
                      <td className="w-20 h-20">
                        <select
                          ...
                          onChange={(e) => {
                            handleSection(e.target.value, index);
                          }}
                          style={{
                            border: isEditable ? false : "2px solid #f8b26a",
                          }}
                        >
                          <option
                            value={0}
                            defaultValue={item.is_primary == 0 ? true : false}
                          >
                            Primary
                          </option>
                          <option
                            value={1}
                            defaultValue={item.is_primary == 1 ? true : false}
                          >
                            Secondary
                          </option>
                        </select>
                      ...
                      <td className="w-20 h-20">
                        <select
                          name=""
                          disabled={isEditable}
                          className=" rounded-md w-24 h-7 text-center"
                          defaultValue={item.stream}
                          onChange={(e) => {
                            handleStream(e.target.value, index);
                          }}
                          style={{
                            border: isEditable ? false : "2px solid #f8b26a",
                          }}
                        >
                          <option
                            value="none"
                            defaultValue={item.stream == "none" ? true : false}
                          >
                            None
                          </option>
                          <option
                            value="commerce"
                            defaultValue={
                              item.stream == "commerce" ? true : false
                            }
                          >
                            Commerce
                          </option>
                          <option
                            value="science"
                            defaultValue={
                              item.stream == "science" ? true : false
                            }
                          >
                            Science
                          </option>
                          <option
                            value="arts"
                            defaultValue={item.stream == "arts" ? true : false}
                          >
                            Arts
                          </option>
                        </select>
                      ...
                      <td className="w-20 h-20">
                        <input
                          ...
                          onChange={(e) => {
                            handleFees(e.target.value, index);
                          }}
                          style={{
                            border: isEditable ? false : "2px solid #f8b26a",
                          }}
            ...
            <div className="button flex justify-end items-center space-x-4">
              <div
                onClick={onSubmit}
                id="transfer-btn"
                className="flex items-center hover:bg-class3-50 bg-orange-400 w-28 h-10 justify-center rounded-lg cursor-pointer space-x-2"
              >
                <div className=""></div>
